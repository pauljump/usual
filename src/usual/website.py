...
def item_page(item_id: str) -> bytes:
    ...
    content = [head(title, item["benefit"], f"/menu/{item_id}/"), '<body>', navigation(),
               ...
               f'<p class="eyebrow">THE COLLECTION / {int(item["number"]):02}</p>',
               ...
               '<details class="instruction-details"><summary>Inspect the local install commands</summary>',
               ...
               '<p class="eyebrow">The particulars</p><h3>At a glance.</h3>',
               '<dl>']
